/**
 * Copyright 2016 Welab, Inc. All rights reserved. WELAB PROPRIETARY/CONFIDENTIAL. Use is subject to
 * license terms.
 */
...
public class ExcelUtils {
    ...
    public static Map<String, Object> excelToMap(InputStream in, List<String> list) throws Exception {
        ...
        try {
            ...
            for (int i = 1; i < sheet.getRows(); i++) {
                if (list.contains(sheet.getCell(0, i).getContents().toString().trim())) {
                    continue;
                }
                map.put(sheet.getCell(0, i).getContents().toString(), sheet.getCell(1, i).getContents().toString().trim());
            }
        ...
        try {
            ...
            for (int i = 0; i < sheet.getRows(); i++) {
                ...
                for (int j = 0; j < sheet.getColumns(); j++) {
                    ...
                    if (Objects.isNull(currentCell) || "".equals(currentCell.getContents().toString())) {
                        nullCols++;
                    }
                }
            ...
            for (int i = 0; i < columnName.length; i++) {
                excelFieldNames[i] = columnName[i].getContents().toString().trim();
            }
    ...
    /**
     * 将excel文件转成list(.xls格式和.xlsx格式)</br>
